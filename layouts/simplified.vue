    ...
    <div class="fixed top-0 z-50 w-full flex items-center justify-center bg-white dark:bg-gray-800 transition-colors duration-300 shadow-sm dark:shadow-gray-900/50">
      <div class="w-full bg-white dark:bg-gray-800 px-4 transition-colors duration-300"
        ...
        <div class="flex items-center h-16">
          <div class="flex items-center justify-center bg-white dark:bg-gray-800 gap-x-0.5 transition-colors duration-300">
            <svg class="w-7 h-7 text-blue-600 dark:text-blue-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24">
            ...
            <NuxtLink :to="localePath('/')" class="merchant-name text-lg font-medium text-gray-800 dark:text-gray-100">
